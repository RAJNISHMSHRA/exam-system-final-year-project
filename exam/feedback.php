...
<title>TEST FOR GEEEKS : PROJECT FINAL YEAR</title>
...
<div class="col-lg-6">
<span class="logo">Test For Geeks </span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-6 panel " style="background: #43cea2;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #185a9d, #43cea2);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #185a9d, #43cea2); color :white; /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
...
<h2 align="center" style="font-family:'typo'; color: white;  /* fallback for old browsers */
background: -webkit-linear-gradient(to right, #4286f4, #373B44);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #4286f4, #373B44);  /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
">FEEDBACK/REPORT A PROBLEM</h2>
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">rs41376@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Rajnish Mishra" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="www.google.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Rajnish Mishra / Saket Bhatt / Rajat Issar / Rohit Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7000593081</h4>
		<h4 style="font-family:'typo' ">rs41376@gmail.com@gmail.com</h4>
		<h4 style="font-family:'typo' ">Shri Shankaracharya College Of ENgineering And Technology,bhilai</h4></div></div>
		</p>
      </div>
